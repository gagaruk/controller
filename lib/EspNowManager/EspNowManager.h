...
public:
    ...
    bool sendData(const uint8_t *targetMac, const PeripheralPacket *data, size_t length);
...
private:
    ...
    static void _onDataRecv(const uint8_t *mac_addr, const TelemetryPacket *incomingData, int len);
